...
export async function POST() {
    return withApiHandler(async () => {
        ...
        // --- 4. ADVANCED TIER (进阶级) ---
        // Let's generate 25 unisex items (5 per category)
        ...
        // --- 5. ENTRY TIER (入门级) ---
        // 35 Unisex items (7 per category)
        ...
        // --- 6. BASIC TIER (白菜级) ---
        // 52 Unisex items (10 or 11 per category)
        ...
        // 11 Gender-exclusive items for Body & Lower in Basic
        ...
        // 3. Batch insert using raw Neon SQL queries
        console.log(`Prepared ${items.length} items to insert...`);
