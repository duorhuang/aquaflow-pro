...
export async function GET() {
    try {
        ...
        return NextResponse.json(swimmers || [], { headers: V7_FINGERPRINT });
    } catch (error: any) {
...
export async function POST(request: Request) {
    try {
        ...
        return NextResponse.json(swimmer, { headers: V7_FINGERPRINT });
    } catch (error: any) {
        ...
        return NextResponse.json({ error: errorMsg }, { status: 500, headers: V7_FINGERPRINT });
    }
}
