...
- Name: e2e/live.spec.ts >> Live Website E2E Tests - 5 Iterations >> Swimmer Login & Verification - Iteration 4
- Location: e2e/live.spec.ts:7:9
...
Call log:
  - waiting for locator('button[role="radio"]').filter({ hasText: '运动员' })
...
- generic [ref=e3]:
  - generic [ref=e4]:
    - 'heading "Error 1102 Ray ID: a064b5efbd178ea3 • 2026-06-04 05:59:17 UTC" [level=1] [ref=e5]'
    - heading "Worker exceeded resource limits" [level=2] [ref=e6]
  - generic [ref=e8]:
    - generic [ref=e9]:
      - heading "What happened?" [level=2] [ref=e10]
      - paragraph [ref=e11]:
        - text: You've requested a page on a website (sw.sportsflow.best) that is on the
        - link "Cloudflare" [ref=e12] [cursor=pointer]:
    ...
    - generic [ref=e13]:
      - heading "What can I do?" [level=2] [ref=e14]
      - paragraph [ref=e15]:
        - strong [ref=e16]: "If you are the owner of this website:"
        - text: refer to
        - link "Workers - Errors and Exceptions" [ref=e17] [cursor=pointer]:
          - /url: https://developers.cloudflare.com/workers/observability/errors/
        - text: and check Workers Logs for sw.sportsflow.best.
  - paragraph [ref=e19]:
    - generic [ref=e20]:
      - text: "Cloudflare Ray ID:"
      - strong [ref=e21]: a064b5efbd178ea3
    - generic [ref=e22]: •
    - generic [ref=e23]:
      - text: "Your IP:"
    ...
    - generic [ref=e26]:
      ...
      - link "Cloudflare" [ref=e27] [cursor=pointer]:
