...
- Name: e2e/live.spec.ts >> Live Website E2E Tests - 5 Iterations >> Swimmer Login & Verification - Iteration 1
- Location: e2e/live.spec.ts:7:9

# Error details

```
Error: page.goto: net::ERR_SOCKET_NOT_CONNECTED at https://sw.sportsflow.best/
Call log:
  - navigating to "https://sw.sportsflow.best/", waiting until "domcontentloaded"
