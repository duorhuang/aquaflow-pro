...
async function seed() {
    console.log("=== Start Seeding Cartoon Hero Avatar Items via Neon HTTP ===");
    ...
    console.log(`2. Generated ${items.length} curated cartoon items. Inserting in batches...`);
    ...
    console.log("✓ Seeding complete! Database successfully populated with the new Cartoon Hero sets.");
}
