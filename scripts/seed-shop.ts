...
/**
 * Script to seed shop items directly using Neon Serverless raw SQL.
 * Run with: npx tsx scripts/seed-shop.ts
 */
async function main() {
    const sql = getNeon();

    console.log('Seeding ShopItem database...');
    ...
    // ==========================================
    // 1. Personal Dress-up (个人装扮) - Clothes (👕)
    // ==========================================
    ...
    // ==========================================
    // 5. Personal Dress-up (个人装扮) - Desk Accessories (🥤)
    // ==========================================
    ...
    // ==========================================
    // 6. Desk Mate Space (同桌空间) - Wallpaper (🔲)
    // ==========================================
    ...
    // ==========================================
    // 7. Desk Mate Space (同桌空间) - Windows (🪟)
    // ==========================================
    ...
    // ==========================================
    // 8. Desk Mate Space (同桌空间) - Desk Ornaments (💻)
    // ==========================================
    // Batch 1 (20 Items)
    ...
    // ==========================================
    // 9. Desk Mate Space (同桌空间) - Wall Hanging (🖼️)
    // ==========================================
    ...
    // ==========================================
    // 10. Desk Mate Space (同桌空间) - Plants (🪴)
    // ==========================================
    ...
    // ==========================================
    // 11. Desk Mate Space (同桌空间) - Cabinets (🗄️)
    // ==========================================
